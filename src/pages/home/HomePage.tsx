...
import type { HomeLoaderResult } from './homeLoader.ts';
  ...
  return (
    <div className="container py-12 space-y-8">
      <div className="space-y-6 text-center">
        ...
        <p className="mx-auto max-w-150 text-gray-500">
          The package manager for JavaScript. Search and view packages.
        </p>
      </div>
      <div className="mx-auto grid grid-cols-4 max-w-225 items-stretch gap-4">
        {renderedPackages}
      </div>
    </div>
  );
